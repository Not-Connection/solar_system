...
class ConfigOptions {
  ...
  factory ConfigOptions.fromJson(String source) => ConfigOptions.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  int get hashCode {
    return antialias.hashCode ^ alpha.hashCode ^ width.hashCode ^ height.hashCode ^ dpr.hashCode;
  }
}
